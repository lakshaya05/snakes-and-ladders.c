...
Coded By Ramal and Lakshaya\n");
printf("Snakes:- 25 to 9,\t 65 to 40,\t 99 to
...
%d\n\n",dice);
if(dice==6)
printf("Dice=6: You have earned a
...
printf("Range exceeded of
Player 1.\n");
displaychart(cur_pos1,"$P1$");
}
printf("Player 2 position is
%d\n",cur_pos2);
break;
case '2':dice=rd();
system("cls");
